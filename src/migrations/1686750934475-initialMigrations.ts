...
export class InitialMigrations1686750934475 implements MigrationInterface {
    name = 'InitialMigrations1686750934475'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "purchases" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "paymentID" integer NOT NULL, "purchaseStatus" character varying(20) NOT NULL, "qrCode" character varying(80) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid, CONSTRAINT "UQ_d4ec3cf995329fe801c3abfc80e" UNIQUE ("paymentID"), CONSTRAINT "PK_1d55032f37a34c6eceacbbca6b8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text NOT NULL, "imageUrl" character varying(255) NOT NULL, "category" character varying(100) NOT NULL, "instock" integer NOT NULL, "tags" json NOT NULL, "reviews" json NOT NULL, "productAvailable" character varying(20) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_purchases" ("id" SERIAL NOT NULL, "price" integer NOT NULL, "quantity" integer, "discount" integer NOT NULL, "total" numeric(15,2), "purchaseDate" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "purchaseId" uuid, "productId" integer, CONSTRAINT "PK_f28cf8bf29b23ab794dfc91f45c" PRIMARY KEY ("id"))`);
