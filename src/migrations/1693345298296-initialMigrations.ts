...
export class InitialMigrations1693345298296 implements MigrationInterface {
    name = 'InitialMigrations1693345298296'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text NOT NULL, "imageUrl" character varying(255) NOT NULL, "expirationDate" date NOT NULL, "category" character varying(100) NOT NULL, "instock" integer NOT NULL, "tags" json NOT NULL, "reviews" json NOT NULL, "productAvailable" character varying(20) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
